...
Set-AzureRmDataFactoryV2Pipeline -DataFactoryName 'RogersDFPOC' Copy -ResourcegroupName RogersPOC -DefinitionFile "D:/a/r1/a/_AartiJaiswal_RogersDFPOC/pipeline/Copy.json"
